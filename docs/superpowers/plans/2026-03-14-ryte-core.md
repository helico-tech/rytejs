...
/** Terminal handler function — receives fully typed context. */
export type Handler<
	TConfig extends WorkflowConfig,
	TDeps,
...
- [ ] **Step 4: Add Context, Middleware, Handler exports to index.ts**

Append to `packages/core/src/index.ts`:

```typescript
export type { Context, Middleware, Handler } from "./context.js";
```
