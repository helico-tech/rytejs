		...
		<div style={{ display: "flex", height: "100vh", overflow: "hidden" }}>
			...
			{manager.activeStore ? (
				<OrderContext.Provider store={manager.activeStore}>
					...
					<DevToolsPanelWithDispatching log={manager.activeLog} />
 ...
 */
function DevToolsPanelWithDispatching({ log }: { log: import("./types.js").LogEntry[] }) {
	const { isDispatching } = OrderContext.useWorkflow();

	return <DevToolsPanel log={log} isDispatching={isDispatching} />;
}
